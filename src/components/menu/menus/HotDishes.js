    ...
    return (
        ...
        <div className = "item-container">
            ...
            <Container >
                ...
                <Row>
                    <Col xs = {9} sm = {9} md = {9} xl = {9}>
                        <p className = "item-p-text">Huevos rotos con <small>(Jamon, chistorra, bacon o morcilla)</small></p>
                    </Col>
                    <Col xs = {3} sm = {3} md = {3} xl = {3}>
                ...
                <Row>
                    <Col xs = {9} sm = {9} md = {9} xl = {9}>
                        <p className = "item-p-text">Champiñones con jamón</p>
                    </Col>
                    <Col xs = {3} sm = {3} md = {3} xl = {3}>
                ...
                <Row>
                    ...
                    <Col xs = {3} sm = {3} md = {3} xl = {3}>
                        <p className = "item-p-price">11.20€</p>
                    </Col>
                </Row>
                <Row>
                    <Col xs = {9} sm = {9} md = {9} xl = {9}>
                        <p className = "item-p-text">Gambas o gulas al ajillo</p>
                    </Col>
                    <Col xs = {3} sm = {3} md = {3} xl = {3}>
                ...
                <Row>
                    ...
                    <Col xs = {3} sm = {3} md = {3} xl = {3}>
                        <p className = "item-p-price">9.20€</p>
                    </Col>
                </Row>
                <Row>
                    <Col xs = {6} sm = {6} md = {6} xl = {6}>
                    ...
                    <Col xs = {3} sm = {3} md = {3} xl = {3}>
                        <p className = "item-p-price">5.80€</p>
                    </Col>
                    <Col xs = {3} sm = {3} md = {3} xl = {3}>
                        <p className = "item-p-price">10.50€</p>
                    </Col>
                ...
                <Row>
                    ...
                    <Col xs = {3} sm = {3} md = {3} xl = {3}>
                        <p className = "item-p-price">17.50€</p>
                    </Col>
                </Row>
